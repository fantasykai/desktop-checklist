<template>
  <div class="event-content">
    <div class="event-tab" @click="changeCollapse(0,$event)">待检查
...
<script>
  export default {
    ...
    methods: {
      moveToDone(id){ //已完成
        this.$store.dispatch('checklistdone', id);
      },
      moveToDo(id){ //未完成
        this.$store.dispatch('checklisttodo', id);
      },
      moveCancel(id){ //已忽略
        this.$store.dispatch('checklistcancel', id);
      },
